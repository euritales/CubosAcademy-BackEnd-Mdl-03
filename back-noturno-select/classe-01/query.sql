...
SELECT composicao, tempo FROM musicas WHERE compositor BETWEEN 'Mozart' AND 'Bach';
...
SELECT * FROM musicas WHERE ritmo ILIKE '%quartet%';
...
SELECT * FROM musicas WHERE composicao NOT ILIKE '%quintet%' LIMIT 5;