...
SELECT categoria, count(*) AS "quantidade categoria", sum(estoque) AS "estoque" FROM farmacia WHERE categoria = 'blue' GROUP BY categoria ORDER BY categoria ;
...
SELECT nome, idade, email, AGE(CAST (cadastro AS timestamp)) AS "Tempo de cadastro" FROM usuarios WHERE idade >= 60;
...
SELECT idade, count(idade) as "contador" FROM usuarios WHERE idade >= 18 GROUP BY idade ORDER BY idade;
...
SELECT categoria, count(*) AS "quantidade categoria", sum(estoque) AS "estoque" FROM farmacia GROUP BY categoria ORDER BY categoria;
SELECT categoria, count(*) AS "quantidade remedio" FROM farmacia GROUP BY categoria ORDER BY categoria;


SELECT * FROM farmacia WHERE categoria = 'green';
